    ...
    <Dialog :show="dialogConfig.show" :title="dialogConfig.title" :buttons="dialogConfig.buttons" width="600px"
        ...
        <el-form :model="formData" ref="formDataRef" label-width="40px">
            ...
            <el-form-item label="日期" prop="createTimeRange">
                <el-date-picker v-model="formData.createTimeRange" type="daterange" range-separator="~"
        ...
        <DataList :loading="loading" :dataSource="recordInfo" @loadData="loadRecord" noDataMsg="暂无相关记录">
