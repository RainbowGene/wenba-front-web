    ...
    <div class="comment-item">
        ...
        <div class="comment-info">
            ...
            <div class="reply-info" v-if="commentData.showReply">
                <CommentPost :placeholderInfo="placeholderInfo" :articleId="articleId" :pCommentId="pCommentId"
                    :replyUserId="replyUserId" :avatarWidth="30" :userId="currentUserId" :showInsertImg="false"
